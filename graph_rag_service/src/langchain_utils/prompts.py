...
CYPHER_GENERATION_TEMPLATE = """Твоя задача - найти в схеме графа вершины, чтобы получить о них информацию для ответа на вопрос. Ты должен основываться на предоставленной схеме графа и следовать инструкциям ниже:
...
В итоге, допустимые значения "action": "Final Answer" или "query-knowledge-base-tool"
...
SYSTEM_PROMPT = """Ты - умный помощник по имени Papper, который отвечает на вопросы по документам пользователя."""
